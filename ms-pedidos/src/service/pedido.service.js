...
const MS_CLIENTES = (process.env.CLIENTES_URL || 'http://localhost:3001').replace(/\/$/, '') + '/clientes'
const MS_PRODUTOS = (process.env.PRODUTOS_URL || 'http://localhost:3002').replace(/\/$/, '') + '/produtos'
